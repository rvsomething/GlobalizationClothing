...
const Wrapper = styled.section`
  ...
  .image-cards {
    display: flex;
    flex-direction: column; /* Stacks Boys and Girls sections one below the other */
    gap: 3rem; /* Adds space between the Boys and Girls sections */
  ...
  /* Cards Container for Boys and Girls */
  .cards-container {
    display: grid;
    gap: 1.5rem;
    justify-items: center;
